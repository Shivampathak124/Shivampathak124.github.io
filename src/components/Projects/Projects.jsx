        ...
        <div id='projects'>
            ...
            <div className="project-card">
                ...
                <div className='projectDetails'>
                    ...
                    <div className='projectButtons'>
                        <a href="https://github.com/Shivampathak124/wood-fans" target="_blank" className="project-github-link">View Code</a>
            ...
            <div className="project-card">
                <div className='projectDetails'>
                    ...
                    <div className='projectButtons'>
                        <a href="https://github.com/Shivampathak124/joyful-ring-9720" target="_blank" className="project-github-link">View Code</a>
                        <a href="https://github.com/Shivampathak124/joyful-ring-9720" target="_blank" className="project-deployed-link">View Live App</a>
                    </div>
                </div>
                <div>
